    ...
    (function (window) {
        ...
        function KMath(options) {
            ...
            this._init = function () {
                ...
                $matrixTable.find('td').click(function(){
        ...
        function ControlBox() {
            ...
            this.Basic = [
                ...
                new Symbol('\\overrightarrow', '\\overrightarrow{}', 'group10', '\\overrightarrow{abc}', 'font-size: 0.95em;', '', 'icon'),
                new Symbol('\\overleftarrow', '\\overleftarrow{}', 'group10', '\\overleftarrow{abc}', 'font-size: 0.95em;', '', 'icon'),
                new Symbol('\\overline', '\\overline{}', 'group10', '\\overline{abc}', 'font-size: 0.95em;', '', 'icon'),
                ...
                // new Symbol('∯', '∯', 'group5', '∯'),
                // new Symbol('∰', '∰', 'group5', '∰'),
                new Symbol('\\oint', '\\oint{x}', 'group16', '\\oint', 'font-size: 1.5em;', ''),
                new Symbol('\\oint _{} {x}', '\\oint _{a} {x}', 'group16', '\\oint_{a}', 'font-size: 1.5em;', 'true', 'icon'),
                new Symbol('\\bigcap', '\\bigcap{n}', 'group16', '\\bigcap', 'font-size: 1.9em;', ''),
                new Symbol('\\bigcap _{} {x}', '\\bigcap _{a} {x}', 'group16', '\\bigcap{a}', 'font-size: 1.5em;', 'true', 'icon'),
                new Symbol('\\bigcap _{}^{} {x}', '\\bigcap _{a}^{b} {x}', 'group16', '\\bigcap_{a}^{b}', 'font-size: 1.5em;', 'true', 'icon'),
                new Symbol('\\bigcup', '\\bigcup{x}', 'group16', '\\bigcup', 'font-size: 1.9em;', ''),
                new Symbol('\\bigcup _{} {x}', '\\bigcup _{a} {x}', 'group16', '\\bigcup_{a}', 'font-size: 1.5em;', 'true', 'icon'),
                new Symbol('\\bigcup _{}^{} {x}', '\\bigcup _{a}^{} {x}', 'group16', '\\bigcup_{a}^{b}', 'font-size: 1.5em;', 'true', 'icon'),
         ...
         * @param {String} style 
         * @param {bool} needUseWrite 设置在basic view中的输入方式（true, mean using write） 
